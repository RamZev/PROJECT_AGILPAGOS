...
# === CREDENCIALES (poné las tuyas reales) ===
ID_ENTIDAD = os.getenv("ID_ENTIDAD", "7F1BDC26-CAB1-4F63-9C23-36CA08589492")
USER_NAME  = os.getenv("USER_NAME",  "admin-api@mutualcalchaqui.com.ar")
PASSWORD   = os.getenv("PASSWORD",   "diL$x}zTCQBaeZx")
